...
export default function AddMeetingPage() {
  redirect("/homepage/add-meeting/new-meeting");
  // return (
...
//     const body = {
//       "platform": "googlemeet",
//       "meetingID": "ato-gvup-ndh",
//       "meetingPassword": "",
//       "userID": "nikhiljaintest"
//     };

//     // const res = await fetch("https://libello-backend-fectcwerekd5c5cc.canadacentral-01.azurewebsites.net/join", {
//     //   method: "POST",
//     //   headers: {
...
//     } else {
//       console.log(`Error while fetching, Error code: ${res.status}, text: ${res.statusText}`);
//     }
//   }
